...
setTimeout(function () {
	...
	PKAudioEditor._deps.Wlc = function () {
			...
			if (PKAE.isMobile) {
				...
				body_str2 = 'Consulte el código base en <a href="https://github.com/rodrixc982" target="_blank">Github</a><br/><br/>'; // revisa el código en github
			}

			// Bienvenido a IIAP-AUDIO,
			var md = new PKSimpleModal({
				title: '<font style="font-size:15px">BIENVENIDO AUDIO IIAP V1.1 </font>',
			...
			body:'<div style="overflow:auto;-webkit-overflow-scrolling:touch;max-width:580px;width:calc(100vw - 40px);max-height:calc(100vh - 340px);min-height:110px;font-size:13px; color:#95c6c6;padding-top:7px;">'+
				'AUDIO IIAP  es un Softwarede audio y forma de Espectrograma, <br />Se ejecuta completamente en el navegador sin backend ni se requieren complementos.'+
				'<br/><br/><br/>'+
				body_str+
